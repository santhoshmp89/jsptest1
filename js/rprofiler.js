        ...
        switch (_a.label) {
            case 0:
                ...
                getAppDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fetch('portalstage.catchpoint.com/jp/1826/v4.0.5/s.AC')];
                            case 1:
                                response = _a.sent();
...
var addScroreToIndicator = function (score) {
    var init = function () {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        window.RProfiler.addInfo('indicator', 'lm_indicator', score);
    };
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
...
var addScroreToTracepoint = function (score) {
    ...
    var init = function () {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        window.RProfiler.addInfo('tracepoint', 'lm_tracepoint', scoreText);
    };
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    window.RProfiler ? init() : window.addEventListener('GlimpseLoaded', init);
    ...
    if (!intervalId) {
        intervalId = setInterval(function () {
            ...
            if (((_a = window === null || window === void 0 ? void 0 : window.lastMileResults) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                ...
                addScroreToIndicator(score);
                addScroreToTracepoint(score);
            }
        }, 1000);
    }
};

...
var MainConfig = /** @class */ (function () {
    ...
    MainConfig.config = {
        ...
        debugUrl: 'localhost:44394/jp/v4.0.6/s.D',
        ...
        ajaxDomains: '',
        useBenchmark: false,
        lastMileUrl: _f.protocol + 'localhost:44394/jp/1826/v4.0.6/LastMileScript.js'
    };
    return MainConfig;
}());
        ...
        switch (_a.label) {
            case 0:
                ...
                getAppDetails = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fetch('https://localhost:44394/jp/1826/v4.0.6/s.AC')];
                            case 1:
                                response = _a.sent();
...
var RProfiler = /** @class */ (function () {
    function RProfiler() {
        ...
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        this.restUrl = 'localhost:44394/jp/1826/v4.0.6/s.M';
        this.startTime = new Date().getTime();
        this.eventsTimingHandler = new rprofiler_EventsTimingHandler();
        this.inpDe = [];
        this.version = 'v4.0.6'; //version number of inline script
        this.info = {};
